      ...
      <div class="custom-container">
        <div class="flex items-center">
          <div class="lg:w-1/2 lg:block hidden">
            <p class="py-10">Bagikan jika Anda menyukai halaman ini.</p>
          </div>
          <div class="lg:w-1/2 w-full flex lg:justify-start justify-center">
            <button class="w-10 h-10 rounded bg-blue-700 text-xl inline-flex m-3 text-white">
              <i class="fa fa-facebook m-auto" aria-hidden="true"></i>
            </button>
            <button class="w-10 h-10 rounded bg-blue-400 text-xl inline-flex m-3 text-white">
              <i class="fa fa-twitter m-auto" aria-hidden="true"></i>
            </button>
            <button class="w-10 h-10 rounded bg-red-600 text-xl inline-flex m-3 text-white">
