<template>
  <div class="custom-container">
    ...
    <div class="flex flex-wrap">
      <div class="lg:w-1/3 w-full lg:my-10 my-4">
        <div class="flex items-center justify-center mb-4">
          <img src="/assets/svg/icon PHP Hosting_PHP Semua Versi.svg" class="w-20" alt="semua versi">
        </div>
        <div>
      ...
      <div class="lg:w-1/3 w-full lg:my-10 my-4">
        <div class="flex items-center justify-center mb-4">
          <img src="/assets/svg/icon PHP Hosting_My SQL.svg" class="w-20" alt="semua versi">
        </div>
        <div>
      ...
      <div class="lg:w-1/3 w-full lg:my-10 my-4">
        <div class="flex items-center justify-center mb-4">
          <img src="/assets/svg/icon PHP Hosting_CPanel.svg" class="w-20" alt="semua versi">
        </div>
        <div>
      ...
      <div class="lg:w-1/3 w-full lg:my-10 my-4">
        <div class="flex items-center justify-center mb-4">
          <img src="/assets/svg/icon PHP Hosting_garansi uptime.svg" class="w-20" alt="semua versi">
        </div>
        <div>
      ...
      <div class="lg:w-1/3 w-full lg:my-10 my-4">
        <div class="flex items-center justify-center mb-4">
          <img src="/assets/svg/icon PHP Hosting_InnoDB.svg" class="w-20" alt="semua versi">
        </div>
        <div>
      ...
      <div class="lg:w-1/3 w-full lg:my-10 my-4">
        <div class="flex items-center justify-center mb-4">
          <img src="/assets/svg/icon PHP Hosting_My SQL remote.svg" class="w-20" alt="semua versi">
        </div>
        <div>
